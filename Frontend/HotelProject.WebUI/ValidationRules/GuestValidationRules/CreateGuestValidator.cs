...
namespace HotelProject.WebUI.ValidationRules.GuestValidationRules
{
    public class CreateGuestValidator : AbstractValidator<CreateGuestDto>
    {
        public CreateGuestValidator()
        {
            ...
            RuleFor(x => x.Name).MaximumLength(20).WithMessage("Lütfen en fazla 3 karakter veri girişi yapınız");
            RuleFor(x => x.Surname).MaximumLength(30).WithMessage("Lütfen en fazla 2 karakter veri girişi yapınız");
            RuleFor(x => x.Surname).MaximumLength(20).WithMessage("Lütfen en fazla 3 karakter veri girişi yapınız");
        }
    }
}
